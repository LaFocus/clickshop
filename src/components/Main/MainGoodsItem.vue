    ...
    <div class="mainGoodsItem" v-if="props.item">
        <div class="mainGoodsItem__inner">
            <div class="mainGoodsItem__inner-img">
                ...
                <!-- <button > -->
                    <svg  @click="addItemToShopANDLOCAL" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
...
const itemToLocal = (e) => {
    ...
    // Обновляем значение атрибута fill в DOM элементе
    if (likeFill.value) {
