        ...
        <div class="mainGoodsItem__inner">
            <div class="mainGoodsItem__inner-img">
                <router-link :to="`/productpage/${props.item.id}`">
                    ...
                    <svg  @click="addItemToShopANDLOCAL"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" 
                        class="mainGoodsItem__inner-img-cart">
                        <path
                    ...
                    <svg @click="itemToLocal(props.item, $event)"  xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 20" :fill="fillValue"
